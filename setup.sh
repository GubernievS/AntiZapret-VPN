...
# 2. Загрузить папку setup на сервер в папку root по SFTP (например через программу FileZilla)
# 3. В консоли под root выполнить:
# chmod +x setup/setup.sh && setup/setup.sh
# 4. Скопировать файл antizapret-client-udp.ovpn или antizapret-client-tcp.ovpn с сервера из папки /root/easy-rsa-ipsec/CLIENT_KEY
#
