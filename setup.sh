...
echo "    3) Cloudflare + Quad9  - Use only if you do not want Yandex - Not recommended"
...
python3 -m pip install --force-reinstall --break-system-packages --no-egg-info /tmp/dnslib
