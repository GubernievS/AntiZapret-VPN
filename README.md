...
При ошибке загрузки файла подключения необходимо сократить длину файла до 32 (Windows) или 15 (Linux/Android/iOS) символов и убрать скобки\
...
Если в течение одной минуты с IP-адреса или со всех IPv4-адресов подсети /24 или со всех IPv6-адресов подсети /64 не было попыток подключения, лимиты сбрасываются\
