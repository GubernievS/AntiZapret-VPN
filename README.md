...
AntiZapret VPN (antizapret-\*) и обычный VPN (vpn-\*) работают через: [OpenVPN](https://openvpn.net/client) и [WireGuard](https://www.wireguard.com/install)
...
Используются порты 50080 и 50443, а также резервные порты 80 и 443 для обхода блокировок\
...
По умолчанию используется быстрый Cloudflare DNS, можно включить AdGuard DNS для блокировки рекламы, отслеживающих модулей и фишинга
