...
Если ваш зарубежный сервер с АнтиЗапретом оказался заблокирован, то к нему можно настроить подключение через свой новый сервер(#где-купить-сервер) в России
...
Если в течение 10 минут не было попыток подключения - лимиты для IP-адреса сбрасываются\
