...
**Внимание!** Для правильной работы AntiZapret VPN или полный VPN нужно на клиентах:
1. [Отключить безопасный или сторонний DNS в браузере](https://www.google.ru/search?q=отключить+DNS+в+браузере)
2. Отключить IPv6 на роутерах или клиентах
3. В адресной строке браузера открыть и отключить опцию Local Network Access Checks выбрав Disabled:
```
