...
2. Если есть проблемы с загрузкой или отображением страниц и картинок в браузере, то открываем: chrome://flags/#local-network-access-check и отключаем опцию Local Network Access Checks
