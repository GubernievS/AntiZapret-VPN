...
Подключение по SSH блокируется на 10 минут с 6-й попытки подключения с одного IP-адреса или суммарно со всех IPv4-адресов подсети /24 или со всех IPv6-адресов подсети /64\
Если в течение 10 минут с IP-адреса или подсети не было попыток подключения - лимит сбрасывается\
