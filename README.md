...
3. Если в браузере есть проблемы с загрузкой или отображением страниц и картинок, то в адресной строке браузера открываем и отключаем опцию Local Network Access Checks:
```
