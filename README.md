...
- Сканирование портов: более 10 попыток подключения по разным портам и протоколам с одного IP-адреса или со всех IP-адресов подсети /24
- DDoS-атака: более 10000 новых подключений по разным портам и протоколам с одного IP-адреса
