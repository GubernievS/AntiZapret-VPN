...
2. Если в браузере есть проблемы с загрузкой или отображением страниц и картинок, то в адресной строке браузера открываем: chrome://flags/#local-network-access-check и отключаем опцию Local Network Access Checks
