...
6. Как работает защита от сканирования и сетевых атак?

> Ответ на пинг отключен
Правила блокировки на 10 минут:
- Сканирование портов: более 3 попыток подключения по разным протоколам и портам в первую минуту
...
```sh
ipset list antizapret-blocklist
```
> Список новых подключений за последние 10 секунд
```sh
ipset list antizapret-newlist
```
