...
DEBIAN_FRONTEND=noninteractive apt install -y curl tar perl build-essential libssl-dev pkg-config libsystemd-dev libpam0g-dev automake libnl-genl-3-dev libcap-ng-dev
rm -rf /root/openvpn
