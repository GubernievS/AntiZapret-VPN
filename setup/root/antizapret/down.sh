...
# Torrent guard
iptables -w -D FORWARD -s ${IP}.28.0.0/16 -p tcp -m string --algo kmp --from 0 --to 200 --string "info_hash" -m string --algo kmp --from 0 --to 200 --string "peer_id" -j SET --add-set antizapret-torrent src --exist
iptables -w -D FORWARD -s ${IP}.28.0.0/16 -p udp -m string --algo kmp --from 0 --to 200 --string "info_hash" -m string --algo kmp --from 0 --to 200 --string "get_peers" -j SET --add-set antizapret-torrent src --exist
