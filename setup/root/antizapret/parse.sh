...
if [[ -z "$1" || "$1" == "host" || "$1" == "hosts" ]]; then
	...
	grep -Ev 'cazin|casin|cacin|kazin|kasin|kacin|asino|asiino|assino|azino|aziino|azzino|acino|1xbet|1-xbet|1x-bet|vavada|1win|1-win|vulkan|vulcan|wulkan|admiral|mostbet|leonbet|1xslot|riobet|bkleon|melbet|ramenbet|ramen-bet|fairspin|sykaaa|slotozal|goldfishka|playfortuna|play-fortuna|dragon-money|dragonmoney|poker-dom|pokerdom|maxslot|eldorado|cryptobos|crypto-bos|gogame|legzo|slottica' temp/include-hosts.txt > temp/include-hosts2.txt \
